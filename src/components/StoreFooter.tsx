  ...
  return (
    <footer className="store-footer">
      <div className="store-shell footer-grid">
        ...
        <div className="footer-links"><NavLink to="/">Store</NavLink><NavLink to="/hardware">Hardware</NavLink><NavLink to="/software">Software</NavLink><NavLink to="/seller">Sell</NavLink><NavLink to="/support">Support</NavLink><NavLink to="/account">Account</NavLink></div>
